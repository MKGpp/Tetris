...
public:	
	...
	int getContent(const int col, const int row) const;			
	...
	void setContent(const Point& p, const int content);	
	...
	void setContent(const int col, const int row, const int content);		
	...
	void setContent(const std::vector<Point>& p, const int content);		
